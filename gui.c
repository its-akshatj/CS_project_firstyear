...
button buttons[10] = {(button){(Vector2){20,20},(Vector2){20,20},&ScreenClearButton,"textures\\clearscreenbutton.png"},
                     ...
                     (button){(Vector2){20,41},(Vector2){20,20},&LineTool,"textures\\linetool.png"},
                     (button){(Vector2){147,655},(Vector2){20,20},&RatioLock,"textures\\ratiochain.png"},
                     (button){(Vector2){60,20},(Vector2){100,20},&Bored,"textures\\bored.png"},
                     (button){(Vector2){20,61},(Vector2){22,20},&Eraser,"textures\\eraser.png"},
